...
def setup_commands(tree: discord.app_commands.CommandTree, guild_id: int):
    ...
    async def price_command(interaction: discord.Interaction, coin: str):
        status, amount, base, currency = get_sell_price(coin)
        if (status == 200):
